...
class SchoolCMS extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            services: [],
    ...
    getSchools(service_id) {
        ...
        axios.get(this.props.subServicesURL, params).then((res) => {
            this.setState({
                schools: res.data
            });
        });
    ...
    handleSubmit(e) {
        ...
        axios.post(this.props.upsert, params).then((res) => {
            this.setState({
                school: {
                    id: 0,
                    name: '',
    ...
    render() {
        ...
        return (
            <div className="card">
                <h1 className="is-size-2 has-text-centered">{this.props.title}</h1>
